package com.example.musiccrawler.theme;

import static android.view.View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN;
import static android.view.View.SYSTEM_UI_FLAG_LAYOUT_STABLE;
import static android.view.View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR;
import static com.example.musiccrawler.theme.ThemeStore.getMaterialPrimaryColor;
...
public class StatusBarUtil {
  ...
  public static void setStatusBarMode(Activity activity, int color) {
    ...
    boolean isDarkMode = MeizuStatusbar.toGrey(color) >= 254;
    //获得miui版本
    String miui = "";
    int miuiVersion = 0;
