package com.example.yuehaoting.lyrics.widget.make;
...
import com.example.yuehaoting.lyrics.model.make.MakeLrcLineInfo;
...
public class MakeLyricsView extends View {
    ...
    private void drawIndicator(Canvas canvas) {
        ...
        LinearGradient linearGradientHL = new LinearGradient(lineLeft, lineY + lineH, lineR, lineY + lineH, new int[]{
            ColorUtils.parserColor(mPaintLineColor, 255), ColorUtils.parserColor(mPaintLineColor, 0), ColorUtils.parserColor(mPaintLineColor, 0), ColorUtils.parserColor(mPaintLineColor, 255)}, new float[]{0f, 0.2f, 0.8f, 1f}, Shader.TileMode.CLAMP);
